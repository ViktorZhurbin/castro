		...
		<div class="hero flex-1 bg-base-200">
			<div class="hero-content text-center">
				<div class="max-w-lg">
					...
					<h1 class="font-display text-9xl text-primary">404</h1>
					<div class="divider divider-primary max-w-xs mx-auto" />
					<h2 class="font-display text-4xl mb-8 text-secondary">
						PAGE NOT FOUND
					</h2>
					...
					<a href="/" class="btn btn-primary btn-lg font-display text-xl">
