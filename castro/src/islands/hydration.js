 ...
 *
 * How it works:
 * 1. Server renders HTML like: <castro-island directive="comrade:visible" import="/islands/counter.js" data-props='{"initial":5}'>
 ...
 * 5. Dynamically imports the component JS (which exports a mounting function)
 * 6. Calls the mounting function with the container and props to hydrate
 *
 ...
 *
 * Framework-specific hydration logic is baked into each island's
 * mounting function during compilation (compiler.js).
 */
...
class CastroIsland extends HTMLElement {
	...
	async hydrate() {
		...
		try {
			...
			// Get the path from import="/islands/counter.js" attribute
			...
			// It receives the container element and props, then performs
			// framework-specific hydration (Preact hydrate(), Solid hydrate(), etc.)
